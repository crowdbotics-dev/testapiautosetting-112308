...
## Project Structure
    ...
    ├── testapiautosetting_112308  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_112308`
...
2. Clone this repo and `cd testapiautosetting_112308`
